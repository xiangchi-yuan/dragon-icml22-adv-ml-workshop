...
from utils import AdvTrainer_diversity
import argparse
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--data_dir', type=str, default="/home/chunhui/data/grb_data/")
    argparser.add_argument('--device', type=str, default="cuda:0")

    argparser.add_argument('--n_epoch', type=int, default=10000)
    ...
    argparser.add_argument('--feat_dropout', type=float, default=0.6)
    argparser.add_argument('--attn_dropout', type=float, default=0.6)
