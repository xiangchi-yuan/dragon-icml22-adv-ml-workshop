...
class MoE(nn.Module):
    ...
    def __init__(self, input_size, output_size, num_experts=4, noisy_gating=True, k=1):
        ...
        self.k = k
        # instantiate experts
        self.experts = nn.ModuleList([nn.Linear(self.input_size, self.output_size, bias=True) for i in range(self.num_experts)])
