...
if __name__ == '__main__':
    ...
    attack_dict = {}
    for i in range(6):
        attack_dict[i] = os.path.join(args.attack_dir, args.attack + "_vs_" + "gcn_ln", "dmae" + str(i))
    ...
    for model_name in model_list:
        ...
        for i in range(0, 6):
            ...
            adj_attacked = sp.csr_matrix(adj_attack)
            features_attacked = np.load(os.path.join(attack_dict[i], args.attack_feat_name))
