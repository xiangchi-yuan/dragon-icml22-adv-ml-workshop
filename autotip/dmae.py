...
train_data, val_data, test_data = T.RandomLinkSplit(num_val=0.05, num_test=0.25,
                                                    is_undirected=True,
                                                    split_labels=True,
...
# train_data = splits['train'].to('cuda:0')
...
save_dir = "../saved_models/{}/{}".format('grb-cora', 'gatdp1')
save_name = "model.pt"
device = "cuda:0"
...
test_score = utils.evaluate(model,
                            ...
                            device=device)
print("Test score after attack for target model: {:.4f}.".format(test_score) + "gat")
#
